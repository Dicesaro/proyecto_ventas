...
class InventariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventario" do
    assert_difference("Inventario.count") do
      post inventarios_url, params: { inventario: { cantidad: @inventario.cantidad, producto_id: @inventario.producto_id } }
    end
  ...
  test "should update inventario" do
    patch inventario_url(@inventario), params: { inventario: { cantidad: @inventario.cantidad, producto_id: @inventario.producto_id } }
